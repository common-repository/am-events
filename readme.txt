...
Tags: events, event, venue, calendar, dates, date, list, workshop, concert, meeting, summit, class, upcoming, widget
...
= 1.13.1 =
* Fixes a debug PHP error on some admin pages

= 1.13.0 =
* Replaces jQuery datepicker with flatpickr
